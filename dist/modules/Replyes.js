...
class Replyes extends CommentSystem {
    ...
    addListenerReplyBtn(commentID) {
        const commentBlock = document.querySelector(`[data-commentid="${commentID}"]`); // получение конкретного "комент блока"
        if (commentBlock) {
            ...
            const btnReplyListener = (event) => {
                ...
                if (event.target === replyBtn) {
                    ...
                    this.preNickname = (_a = commentBlock.querySelector('.commentBlock__nickname')) === null || _a === void 0 ? void 0 : _a.innerHTML;
